...
//Appliquer le Thème Que l'uiliqtateur choisir le dernièr foix
...
//lire le style a partir de base de doneé
  Style:=DataModule1.FDQuery2.FieldByName('Theme').AsString;
//appliquer le Style
  TStyleManager.SetStyle(Style);
end;
//Switcher On est Off les Paramètre
